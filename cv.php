...
$jobs = [
  ...
  [
    ...
    'description' => 'This is an wonderful job!!!'
  ],
  [
    'title' => 'Java Developer',
    'description' => 'This is an amazing job!!!'
  ],
  [

    'title' => 'JavaScript Develper',
    'description' => 'This is an exciting job!!!'
  ],
  [
    'title' => 'Go Develper',
    'description' => 'This is an interesting job!!!'
  ]
];
...
<body>
  <div class="container">
      ...
      <div class="col">
        <div>
          ...
          <ul>
            ...
            <li class="work-position">
              <h5><?php echo $jobs[3]['title']; ?></h5>
              <p><?php echo $jobs[3]['description']; ?></p>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi sapiente sed pariatur sint exercitationem eos expedita eveniet veniam ullam, quia neque facilis dicta voluptatibus. Eveniet doloremque ipsum itaque obcaecati nihil.</p>
              <strong>Achievements:</strong>
              <ul>
                <li>Lorem ipsum dolor sit amet, 80% consectetuer adipiscing elit.</li>
            ...
            <li class="work-position">
              <h5><?php echo $jobs[4]['title']; ?></h5>
              <p><?php echo $jobs[4]['description']; ?></p>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi sapiente sed pariatur sint exercitationem eos expedita eveniet veniam ullam, quia neque facilis dicta voluptatibus. Eveniet doloremque ipsum itaque obcaecati nihil.</p>
              <strong>Achievements:</strong>
              <ul>
                <li>Lorem ipsum dolor sit amet, 80% consectetuer adipiscing elit.</li>
    ...
    <div id="resume-footer" class="row">
      <div class="col">
        Designed by @smarthricardo-Ricardo Andrés Zambrano Cuaicuan
      </div>
    </div>
  </div>
